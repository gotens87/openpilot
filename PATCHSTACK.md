...
| 5 | star-infra        | infra: StarPilot local (konik upload-gate + onroad reboot + onroad poweroff visibility + mapd EIO survival + self-healing UI-prebuilt staleness check) | infra |
